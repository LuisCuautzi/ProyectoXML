...
function dibujaMapa(lat,longi)
{
    ...
    function localizacion(posicion)
    {
        ...
        var marker = new google.maps.Marker({
            position: myLatLng,
            title: "Aquí estamos",
            icon: "https://images.vexels.com/media/users/3/276638/isolated/preview/3c7f4ae8dd0ea448346534aba7ee9d33-trazo-lleno-de-espuelas-de-caballo-del-salvaje-oeste.png"
        });
        marker.setMap(map);
        $("#mapa").css("height", 350);
